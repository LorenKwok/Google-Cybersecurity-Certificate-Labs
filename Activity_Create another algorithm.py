...
# Printing the import_file will print the "allow_list.txt". Printing the remove_list will provid the list of IP addresses that are no longer allowed to access restricted information.
...
with open(import_file, "r") as file:
  ...
  ip_addresses = file.read(import_file)
...
# I would not have to type the entire algorithm each time I want to use it.  I would simply have to use the new function that I defined.
...
# In this lab, I learned to create an algorithm using iterative and conditional statements as well as methods for parsing text file.  I have also learned to define a new function to incorporate this algorithm.
